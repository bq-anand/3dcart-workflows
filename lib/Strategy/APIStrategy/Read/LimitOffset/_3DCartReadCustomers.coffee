...
class _3DCartReadCustomers extends LimitOffset
  ...
  getTotalRequest: (params) -> @binding.getCustomers(params)
  ...
  getPageRequest: (params) -> @binding.getCustomers(params)

module.exports = _3DCartReadCustomers

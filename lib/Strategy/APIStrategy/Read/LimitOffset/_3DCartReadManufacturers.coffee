...
class _3DCartReadManufacturers extends LimitOffset
  ...
  getTotalRequest: (params) -> @binding.getManufacturers(params)
  ...
  getPageRequest: (params) -> @binding.getManufacturers(params)

module.exports = _3DCartReadManufacturers

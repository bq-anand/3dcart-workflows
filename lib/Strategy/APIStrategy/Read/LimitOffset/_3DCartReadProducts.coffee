...
class _3DCartReadProducts extends LimitOffset
  ...
  getTotalRequest: (params) -> @binding.getProducts(params)
  ...
  getPageRequest: (params) -> @binding.getProducts(params)

module.exports = _3DCartReadProducts

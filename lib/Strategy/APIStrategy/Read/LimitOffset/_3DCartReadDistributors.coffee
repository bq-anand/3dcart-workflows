...
class _3DCartReadDistributors extends LimitOffset
  ...
  getTotalRequest: (params) -> @binding.getDistributors(params)
  ...
  getPageRequest: (params) -> @binding.getDistributors(params)

module.exports = _3DCartReadDistributors

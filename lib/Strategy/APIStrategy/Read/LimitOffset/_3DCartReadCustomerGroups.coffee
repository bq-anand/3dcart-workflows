...
class _3DCartReadCustomerGroups extends LimitOffset
  ...
  getTotalRequest: (params) -> @binding.getCustomerGroups(params)
  ...
  getPageRequest: (params) -> @binding.getCustomerGroups(params)

module.exports = _3DCartReadCustomerGroups

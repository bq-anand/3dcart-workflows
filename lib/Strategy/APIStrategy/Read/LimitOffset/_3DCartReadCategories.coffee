...
class _3DCartReadCategories extends LimitOffset
  ...
  getTotalRequest: (params) -> @binding.getCategories(params)
  ...
  getPageRequest: (params) -> @binding.getCategories(params)

module.exports = _3DCartReadCategories
